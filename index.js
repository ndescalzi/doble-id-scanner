...
function generateMarkdown (
  ...
  md += `---\n\n*Generated by [doble-id-scanner](https://www.npmjs.com/package/doble-id-scanner)*\n`
  return md
}
...
${bold('Usage:')}
  npx doble-id-scanner [options] [path]
...
${bold('Examples:')}
  npx doble-id-scanner                   # scan current dir
  npx doble-id-scanner ./src             # scan a specific folder
  npx doble-id-scanner --json            # JSON output, current dir
  npx doble-id-scanner --file            # save idScan.md if duplicates found
  npx doble-id-scanner --file --json     # save idScan.json if duplicates found
  npx doble-id-scanner ./src --file      # path + file flag (any order)
  npx doble-id-scanner --file ./src      # same, different order
  npx doble-id-scanner --no-build        # skip build output dirs
  npx doble-id-scanner --path ./src      # explicit path flag
  npx doble-id-scanner --dynamic         # include dynamic id bindings
  npx doble-id-scanner --dynamic --file  # dynamic scan, save report
`)
    process.exit(0)
  }
